...
public class UserController {
    ...
    @GetMapping(value = "/api/user/loadDifferentUserById")
    public User loadDifferentUserById(@RequestParam("id") long userId) {
        return this.userService.loadDifferentUserById(userId);
    }
}
